...
/**
 * A SenderWapper class as decoration class for user to subscribe and unsubscribe by mail. User can
 * set the basic information of request by included several methods. Then,send the request data by a
 * mode of mail.
 * 
 * @see MailApi
...
public class AddressBook extends SenderWapper {
    ...
    public AddressBook setAddress(String address, String name) {
